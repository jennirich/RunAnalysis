...
The script used to create the Means data set is the run_analysis.R script in this repos.  The script has many descriptive comments on the processing.

The CodeBook for this script is posted in this repos; a somewhat shorter version follows in this README file.

A copy of the final Means dataset, 'tidy_data_Human\_Activity\_Smartphone\_Recognition\_Variable\_Means' is also posted in this repo.
